...
namespace SportsLeague.Domain.Services
{
    public class StandingsService : IStandingsService
    {
        ...
        public async Task<object> GetStandingsAsync(int tournamentId)
        {
            ...
            // de la lista de resultados, donde la clave es el MatchId y el valor es el MatchResult correspondiente.
            // Esto permite acceder rápidamente al resultado de un partido dado su ID sin tener que recorrer toda la lista cada vez.
            ...
            var standings = tournamentTeams.Select(tt =>
            {
                ...
                //resultaron en una victoria para el equipo, es decir,
